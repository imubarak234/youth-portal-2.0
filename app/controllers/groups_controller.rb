class GroupsController < ApplicationController
  ...
  def create
    group_create = Group.new(params.require(:groups).permit(:year_of_establishment, :nature_of_support_group,
                                                            :mode_of_funding, :state, :lga, :active_region, :number_of_members, :head_office_address, :focus_of_support_group, :zonal_office_address, :region_of_operation, :geo_political_zone, :branch_offices, :senatorial_district, :name_of_support_group, :membership_status))
